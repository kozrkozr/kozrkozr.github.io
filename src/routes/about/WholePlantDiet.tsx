    ...
    <div>
      ...
      <section className="px-24 mb-72">
        ...
        <p className="font-weight-300">
          &nbsp;&nbsp;Між повноцінною, рослинною (WFPB) і веганською є схожості, але є також деякі ключові відмінності. Веганська дієта може
          включати високо оброблену імітацію м’яса та сиру; дієта WFPB уникає цих продуктів на користь повних або мінімально оброблених
          продуктів, близьких до природи, які дозволяють легко задовольнити ваші потреби в харчуванні.{' '}
        </p>
      </section>
      ...
      <section className="px-24 mb-72">
        ...
        <ul className="pl-24 font-weight-300 mb-20 disc">
          <li className="mb-20">
        ...
        <p className="font-weight-300 mb-20">
          &nbsp;&nbsp;Якщо ви додасте в раціон на основі рослин продукти тваринного походження, вибирайте якісну продукцію з продуктових
          магазинів або, ще краще, купіть їх у місцевих фермерів.
        </p>
      ...
      <section className="px-24 mb-72 font-weight-300">
        <p>
          &nbsp;&nbsp;Здорова рослинна дієта повинна зосередитися на вживанні продуктів рослин, таких як овочі, фрукти, цільні зерна,
          бобові, горіхи і насіння. Якщо ви їсте продукти тваринного походження, їх слід вживати в менших кількостях в порівнянні з
          рослинними продуктами.
        </p>
      </section>
      ...
      <section className="px-24 mb-72">
        ...
        <p className="font-weight-300 mb-20">
          &nbsp;&nbsp;Рослинна дієта — це раціон харчування , який фокусується на споживанні продуктів в їх самій природній формі. Це
          означає, що сильно оброблені харчові продукти виключаються.
        </p>
        <p className="font-weight-300 mb-20">
          &nbsp;&nbsp;При покупці круп і хліба, зосередьтеся на свіжих продуктах і купуючи продукти з етикеткою, будьте націлені на предмети
          з найменшою кількістю можливих інгредієнтів.
        </p>

        <ul className="pl-24 disc">
          <li className="mb-20">
            <span className="font-weight-400 font-size-md">Фаст-фуд: </span>
            <span className="font-weight-300">картопля фрі, чізбургери, хот-доги, курячі нагетси і т.д.</span>
          </li>
          <li className="mb-20">
            <span className="font-weight-400 font-size-md">Добавки цукру і солодощі: </span>

            <span className="font-weight-300">
              цукор, газовані напої, сік, випічка, печиво, цукерки, солодкий чай, солодкі злаки і т.д.
            </span>
          </li>
          <li className="mb-20">
            <span className="font-weight-400 font-size-md">Рафіновані зерна: </span>
            <span className="font-weight-300">білий рис, білі макарони, білий хліб, бублики і т.д.</span>
          </li>
          <li className="mb-20">
            <span className="font-weight-400 font-size-md">Напівфабрикати: </span>
            <span className="font-weight-300">чіпси, крекери, пластівці, заморожені обіди і т.д.</span>
          </li>
          <li className="mb-20">
            <span className="font-weight-400 font-size-md">Оброблені «вегетаріанські» продукти: </span>
            <span className="font-weight-300">спеціальні м’ясні продукти, штучні сири, вегетаріанські масла і т.д.</span>
          </li>
          <li className="mb-20">
            <span className="font-weight-400 font-size-md">Штучні підсолоджувачі: </span>
            <span className="font-weight-300">синтетичні цукрозамінники і т.д.</span>
          </li>
          <li className="mb-20">
            <span className="font-weight-400 font-size-md">Оброблені продукти тваринного походження: </span>
            <span className="font-weight-300">бекон, м’ясо, ковбаса і т.д.</span>
          </li>
        </ul>
      </section>
    </div>
